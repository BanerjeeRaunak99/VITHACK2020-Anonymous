...
diagnosisData = pd.read_csv("Respiratory_Sound_Database/patient_diagnosis.csv", header=None)
diagnosisData.columns= ["Patient No", "Disease"]


# Reading the demographic data
demographicData = pd.read_csv("demographic_info.txt", delimiter=" ", header=None)
